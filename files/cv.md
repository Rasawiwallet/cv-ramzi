<div align="center">
    ...
    <h2><b>PROFIL</b></h2>
    <p>
        I am a Computer Science student at Putra Bangsa University with a strong interest in information technology. I actively pursue running as a hobby which helps me maintain discipline and balance.
    </p>
    <p>
        I possess strong competencies in software and hardware, including operating system installation, troubleshooting, device maintenance, and understanding internal PC components.
    </p>
    <p>
    ...
    <ul style="text-align: left; display: inline-block;">
        ...
        <li>Melayani pelanggan dan sales dengan ramah.</li>
        <li>Mengatur display, stok, dan rotasi barang.</li>
    ...
    <ul style="text-align: left; display: inline-block;">
        <li>On-air video operation.</li>
        <li>Planning meeting teknis stasiun TV.</li>
    ...
    <ul style="text-align: left; display: inline-block;">
        <li>Universitas Putra Bangsa Kebumen – Ilmu Komputer (2023 – sekarang)</li>
        <li>SMK TKM Kebumen – Multimedia (2018–2021)</li>
        <li>SMP Negeri 2 Kebumen (2015–2018)</li>
    ...
    <ul style="text-align: left; display: inline-block;">
        ...
        <li>Instalasi software dan OS (Windows).</li>
    ...
    <ul style="text-align: left; display: inline-block;">
        ...
        <li>Pelayanan pelanggan yang ramah dan solutif.</li>
    </ul>
